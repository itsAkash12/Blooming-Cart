  ...
  return (
    <div className='maindel'>
      ...
      <div className='delInfo'>
        <div>
          <div>
            <Text fontSize='3xl' textAlign={"left"} padding="5px">Payment Information</Text>
          </div>
          <div className='address'>
            <div>
              ...
              <div className='method'>
                <div>
                  <img src="https://images.contentstack.io/v3/assets/blt95e0138311135214/blt55a4652be9c043dd/632087e72975ce72ea2faf4f/card-logo.png" alt="" />
                </div>
                <div>
                  <img src="https://images.contentstack.io/v3/assets/blt95e0138311135214/blt18ea45241bb20e3a/632076f927d06f32eeaf01ff/paypal-logo-2.png" alt="" />
                </div>
                <div>
                  <img src="https://images.contentstack.io/v3/assets/blt95e0138311135214/blt517f493effcc3f73/632076f98966566ecdfbb10a/klarna-logo.png" alt="" />
                </div>
              </div>
              <div className='inputtags'>
                ...
                <input type="month" name="" id="" placeholder='MONTH' className='input' />
                <input type="year" name="" id="" placeholder='YEAR' className='input'/>
                <input type="text" name="" id="" placeholder='CVV' className='input'/>
                <h1>Billing Address:</h1>
                <input type="text" placeholder='FIRST NAME' />
                <input type="text" placeholder='LAST NAME' />
                <input type="text" placeholder='BILLING ADDRESS' />
                <input type="text" placeholder='APT/SUITE/ROOM' />
                <div>
